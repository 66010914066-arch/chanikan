...
<style>
    /* ปรับความสูงของ input group ให้เข้ากับ floating label */
...
<div class="container my-5" style="max-width: 700px;">
    ...
    <div class="card shadow-lg border-0 rounded-5">
        ...
        <div class="card-header bg-primary text-white rounded-top-5 p-3">
            <h4 class="mb-0 text-center">ชนิกานต์ ขำสระน้อย (ปุ้ม) -- Gemini </h4>
        </div>
    ...
    if(isset($_POST['Submit'])){
        ...
        // ใช้ Card สำหรับแสดงผลที่ดูเป็น Info (สีฟ้า)
        echo '<div class="card border-info bg-light mt-4 shadow rounded-4">';
        echo '<div class="card-header bg-info text-white rounded-top-4"><h5 class="mb-0">✨ ข้อมูลที่ลงทะเบียนเรียบร้อย:</h5></div>';
        ...
        echo '<span class="d-inline-block border border-dark rounded-circle" style="width: 25px; height: 25px; background:'.$color.';"></span>';
        echo '</p>';
