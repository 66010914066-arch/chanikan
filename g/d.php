...
// แก้ไขบรรทัดที่ 24-25: เขียนคำสั่ง SQL ให้ติดกันและใช้ช่องว่างปกติ
$sql = "SELECT p_country, SUM(p_amount) AS total FROM popsupermarket GROUP BY p_country ORDER BY total DESC";

$rs = mysqli_query($conn, $sql);

// ตรวจสอบว่า Query ทำงานได้จริงไหมเพื่อป้องกัน Error บรรทัดถัดไป
if (!$rs) {
...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        <h1 class="fw-bold text-primary">ชนิกานต์ ขำสระน้อย (ปุ้ม)</h1>
